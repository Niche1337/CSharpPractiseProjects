...
namespace CrawlerGame
{
    class ResurrectingInvader : IInvader
    {
        ...
        public MapLocation Location => _incarnation1.IsNeutralized ? _incarnation1.Location : _incarnation2.Location;

        public bool HasScored => _incarnation1.HasScored || _incarnation2.HasScored;

        public int Health => _incarnation1.IsNeutralized ? _incarnation1.Health : _incarnation2.Health;
